...
const Sphere = {
  intersect: (sphere: [[number, number, number], number, [number, number, number], number], ray: Ray): number | null => {
  ...
  normalAtPoint: (sphere: [[number, number, number], number, [number, number, number], number], point: [number, number, number]): [number, number, number] => {
    // simple circle stuff
